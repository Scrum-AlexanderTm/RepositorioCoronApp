...
public class ObjListaCifra implements Serializable, Parcelable
{
    ...
    public final static Creator<ObjListaCifra> CREATOR = new Creator<ObjListaCifra>() {


        @SuppressWarnings({
            "unchecked"
        })
        public ObjListaCifra createFromParcel(Parcel in) {
            return new ObjListaCifra(in);
        }

        public ObjListaCifra[] newArray(int size) {
            return (new ObjListaCifra[size]);
        }

    }
    ;
    private final static long serialVersionUID = -7972314218275380537L;

    protected ObjListaCifra(Parcel in) {
